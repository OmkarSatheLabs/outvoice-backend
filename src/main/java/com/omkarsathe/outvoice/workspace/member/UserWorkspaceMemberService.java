...
////
////        UserEntity createdBy = userService.findById(currentUserId);
////
...
////                .build();
////
////        CustomRole saved = roleService.save(role);
...
////        }
////
////        // Standard Workspace Role can only be changed to OWNER by the OWNER
