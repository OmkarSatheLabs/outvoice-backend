...
//
////    Workspace[] getWorkspacesById(UUID userId);
//
//    boolean existsByEmail(String email);
//
//    boolean existsByMobileAndPhoneCodeId(String mobile, UUID phoneCodeId);
//
//    boolean existsByIdAndEmailIgnoreCase(UUID id, String email);
//
//    boolean existsByIdAndPhoneCodeIdAndMobile(UUID id, UUID phoneCodeId, String mobile);
//}
