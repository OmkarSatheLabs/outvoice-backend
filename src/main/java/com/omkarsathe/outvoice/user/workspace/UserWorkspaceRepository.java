...
//    @Query("SELECT uw FROM UserWorkspaceEntity uw JOIN FETCH uw.workspace w WHERE uw.user.id = :userId AND uw.workspace.id = :workspaceId")
...
//
//    List<UserWorkspaceEntity> findByUserId(UUID userId);
//
